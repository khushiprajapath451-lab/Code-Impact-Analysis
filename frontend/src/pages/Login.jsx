        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
              <label style={{ color: '#D1D5DB', fontSize: '13px', fontWeight: 600, margin: 0 }}>
                Password
              </label>
              <Link to="/forgot-password" style={{ color: '#818CF8', fontSize: '12.5px', fontWeight: 500, textDecoration: 'none' }}>
                Forgot password?
              </Link>
            </div>
            <div style={{ position: 'relative' }}>
